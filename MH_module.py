...
def MCMC_log(guess,functional_form,proposal,proposal_fun,niter,priors_func,firstiter,seed,savestring, *arg):
    """
...
def MCMC_log_Jeff_new(guess,functional_form,proposal,proposal_fun,niter,priors_func,firstiter,seed,savestring,*arg):
    """
    Same as previous, but for log likelihood
